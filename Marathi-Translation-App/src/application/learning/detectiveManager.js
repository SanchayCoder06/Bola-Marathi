...
export const DetectiveManager = (() => {
  ...
  const IMPOSTOR_GAMES = [
    ...
    { id: "imp-11", difficulty: "Easy", words: ["माझे", "नाव", "जॉन", "आहे."], impostorIndex: 3, explanation: "'नाव' (name) is singular, so the auxiliary verb should be 'आहे' instead of plural 'आहेत'." },
    ...
    { id: "imp-41", difficulty: "Hard", words: ["झाडांची", "पाने", "पडिला."], impostorIndex: 2, explanation: "'पाने' (leaves) is neuter plural. The past verb must be 'पडली' (correct), wait, 'झाडांची पाने पडली' is correct. Let's make an impostor: 'झाडांची पाने पडला.' where 'पडला' is masculine singular instead of neuter plural 'पडली'." },
